...
## [0.31.0](https://github.com/hghalebi/rig/compare/rig-core-v0.30.0...rig-core-v0.31.0) - 2026-02-12

### Added

- *(rig-1189)* structured outputs ([#1382](https://github.com/hghalebi/rig/pull/1382))
- *(rig-core)* add optional model override to CompletionRequest ([#1374](https://github.com/hghalebi/rig/pull/1374))
- *(rig-1180)* support text docs (anthropic) ([#1377](https://github.com/hghalebi/rig/pull/1377))
- Add model listing capability ([#1243](https://github.com/hghalebi/rig/pull/1243))
- *(rig-1168)* add default prompt hook to agent (breaking) ([#1356](https://github.com/hghalebi/rig/pull/1356))
- [**breaking**] upgrade reqwest to 0.13 with rustls as default TLS backend ([#1218](https://github.com/hghalebi/rig/pull/1218))
- *(rig-1182)* single-text serialization to single string (openai) ([#1367](https://github.com/hghalebi/rig/pull/1367))
- add reqwest middleware example ([#1359](https://github.com/hghalebi/rig/pull/1359))

### Fixed

- fix ollama dims miss ([#1199](https://github.com/hghalebi/rig/pull/1199))
- *(rig-1182)* assistantcontent serialization when empty (openai) ([#1369](https://github.com/hghalebi/rig/pull/1369))
- *(rig-1183)* invalid options provided (ollama) ([#1365](https://github.com/hghalebi/rig/pull/1365))

### Other

- run cargo fmt to fix CI formatting checks
- add client builder test to all providers
- add client builder test to all providers
- *(rig-1184)* remove AgentBuilderSimple ([#1368](https://github.com/hghalebi/rig/pull/1368))
- propagate current span to tool call ([#1361](https://github.com/hghalebi/rig/pull/1361))
- *(rig-1176)* unify prompt hook interfaces ([#1352](https://github.com/hghalebi/rig/pull/1352))
